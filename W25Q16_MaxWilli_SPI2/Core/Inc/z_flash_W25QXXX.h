...
#define FLASH_SPI_CS_PIN 	FLASH_CS_Pin
#define FLASH_SPI_CS_PORT	FLASH_CS_GPIO_Port
...
*/
#define EXT_FLASH_PAGE_SIZE		0x0100		//256B 		page size (bits)			x
#define EXT_FLASH_SECTOR_SIZE	0x1000		//4kB 		sector size (bytes) 		x
#define EXT_FLASH_BLOCK_SIZE	0x00010000	//64kB 		block size (bytes) 			x
#define EXT_FLASH_SIZE			0X00200000	//2MB		total size (bytes)      ?
#define EXT_FLASH_PAGE_NUM		0x0002000	//8192		The W25Q16JV array is organized into 8192 programmable pages of 256-bytes each x
#define EXT_FLASH_SECTOR_NUM	0x200		//512 		The W25Q16JV has 512 erasable sectors and 64 erasable blocks respectively       x
#define EXT_FLASH_BLOCK_NUM		0x020		//32		blocks						x
...
/* here values for the W25Q32JV chips
#define EXT_FLASH_PAGE_SIZE		0x0100		//256b 		page size (bits)			x
#define EXT_FLASH_SECTOR_SIZE	0x1000		//4kB 		sector size (bytes) 		x
#define EXT_FLASH_BLOCK_SIZE	0x00010000	//64kB 		block size (bytes) 			x
#define EXT_FLASH_SIZE			0X01000000	//16MB-128Mb	total size (bytes)      ?
#define EXT_FLASH_PAGE_NUM		0x0004000	//16384		The W25Q32JV array is organized into 16,384 programmable pages of 256-bytes each x
#define EXT_FLASH_SECTOR_NUM	0x400		//4096 		The W25Q32JV has 1024 erasable sectors and 64 erasable blocks respectively       x
#define EXT_FLASH_BLOCK_NUM		0x040		//64		blocks						x
*/
